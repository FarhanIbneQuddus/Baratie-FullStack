...
return (
    <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-3xl no-scrollbar overflow-x-auto px-4'>
        <div className='flex gap-4 pb-5'>
            ...
            <div onClick={()=>setShowModal(true)} className='rounded-lg shadow-sm min-w-30 max-2-30 max-h-40 aspect-[3/4] cursor-pointer hover:shadow-lg transition-all duration-200 border-2 border-dashed border-indigo-300 bg-gradient-to-b from-indigo-50 to-white'>
                <div className='bg-gradient-to-r from-indigo-100 to-blue-100 h-full flex flex-col items-center justify-center p-4'>
