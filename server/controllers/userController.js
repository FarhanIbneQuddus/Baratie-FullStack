...
export const followUser = async (req, res) => {
    try {
        ...
        res.json({success: true, message: 'You are following this user now'})
...
export const unfollowUser = async (req, res) => {
    try {
        ...
        res.json({success: true, message: 'You are no longer following this user now'})
...
export const getUserConnections = async (req, res) => {
    try{
        const {userId} = req.auth()
        const user = await User.findById(userId).populate('connectons followers following')
